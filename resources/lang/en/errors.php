...
return [
    ...
    | Admin messages
    |--------------------------------------------------------------------------
    | Shown in the Lunar admin panel / order view.
    | Must NOT be rendered directly to end customers.
    */
    'admin' => [
        // Config / auth
        ...
        // Refunds (admin-initiated, never customer-facing)
        ...
        // Driver-level guards (never reach the API)
    ...
    | Customer messages
    |--------------------------------------------------------------------------
    | Safe to render directly in the browser.
    | Only covers errors the customer can act on — all others fall back to
